...
return new class extends Migration
{
    ...
    {
        Schema::create('receipt_voucher_bodies', function (Blueprint $table) {
            $table->id();
            $table->foreignUuId('receipt_voucher_id')->constrained()->cascadeOnDelete(); // ヘッダのID
    ...
    {
        Schema::dropIfExists('receipt_voucher_bodies');
    }
};
