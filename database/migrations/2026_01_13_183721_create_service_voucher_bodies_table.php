...
return new class extends Migration
{
    ...
    {
        Schema::create('service_voucher_bodies', function (Blueprint $table) {
            $table->id();

            $table->foreignUuid('service_voucher_id')->constrained()->cascadeOnDelete(); // ヘッダのID
            $table->foreignId('service_voucher_row_type_id')->constrained(); // 行区分のID
    ...
    {
        Schema::dropIfExists('service_voucher_bodies');
    }
};
