...
use App\Models\{ User, Client, PaymentMethod, NameSuffix, RefundVoucherBody };
...
class RefundVoucherRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bodies.*.id' => ['nullable', Rule::exists(RefundVoucherBody::class, 'id')],
            ...
            'bodies.*.amount' => 'required|integer|gt:0',
