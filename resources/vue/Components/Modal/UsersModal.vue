<template>
    <Modal ref="modalRef" title="担当者検索">
                        ...
                        <tbody>
                            <tr v-for="user in users">
                                ...
                                <td class="p-0 text-center" style="vertical-align: middle;">
                                    <button class="btn btn-sm btn-link rounded-0 w-100" @click="emits('select', { id: user.id }); hide();">
...
<script setup lang="ts">
    ...
    import type { User, Pagination } from '@/interfaces/Index';
    ...
    const fetchIndex = async () => {
        ...
        const response = await Request.users.index({
