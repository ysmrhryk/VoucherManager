                ...
                <div class="row g-4">
                    ...
                    <div class="col-6">
                        <div class="input-group">
                            ...
                            <Input placeholder="" v-model="client.code" />
                        </div>
                    </div>
                    <div class="col-8">
                        <div class="input-group">
                            <span class="input-group-text rounded-0">名前 *</span>
                            <Input placeholder="" v-model="client.name" />
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="input-group">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            ...
                            <Input placeholder="" v-model="client.postal" />
                        </div>
                    </div>
                    <div class="col-8">
                        <div class="input-group">
                            <span class="input-group-text rounded-0">住所</span>
                            <Input placeholder="" v-model="client.address" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group">
                            <span class="input-group-text rounded-0">電話番号</span>
                            <Input type="tel" placeholder="" v-model="client.tel" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group">
                            <span class="input-group-text rounded-0">FAX番号</span>
                            <Input type="tel" placeholder="" v-model="client.fax" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group">
                            <span class="input-group-text rounded-0">メールアドレス</span>
                            <Input type="email" placeholder="" v-model="client.email" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group">
                            <span class="input-group-text rounded-0">ウェブサイト</span>
                            <Input type="url" placeholder="" v-model="client.website" />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            <Input type="number" placeholder="" v-model="client.initial_previous_invoice_amount" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group">
                    ...
                    <div class="col-6">
                        <div class="input-group">
                            ...
                            <Input type="number" placeholder="" v-model="client.billing_day" :disabled="client.billing_cycle_type_id != 2" min="1" max="31" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group">
                    ...
                    <div class="col-4">
                        <button class="btn btn-primary w-100 rounded-0" @click="update()" :disabled="isLoading.update">
                            <Spinner :sm="true" :show="isLoading.update" />
                            <template v-if="!isLoading.update"><i class="fa-solid fa-floppy-disk"></i> 更新</template>
                        </button>
                    </div>
                </div>
            </div>
...
<script setup lang="ts">
    ...
    const update = async () => {
        ...
        try{
            let res = await api.put(`/clients/${route.params.id}`, client.value);
    ...
    const show = async () => {
        try{
            let res = await api.get(`/clients/${route.params.id}`);
