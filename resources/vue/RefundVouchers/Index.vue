<template>
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-4">
                <router-link :to="{ name: 'refund_vouchers.store' }" class="btn btn-primary w-100 rounded-0">新規追加</router-link>
            </div>
                    ...
                    <tbody>
                        <tr v-for="row in data" :key="row.id">
                            ...
                            <td class="p-0 text-center" style="vertical-align: middle;">
                                <router-link 
                                    :to="{ name: 'refund_vouchers.update', params: { id: row.id } }"
...
<script setup lang="ts">
    ...
    const fetchIndex = async () => {
        ...
        await api.get(`/refund-vouchers${stringify(filter.value, page.value)}`)
        .then((res) => {
